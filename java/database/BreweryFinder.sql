...
DROP TABLE IF EXISTS brewery_reviews, beer_reviews, brewery_beer, beer, brewery, time;
...
INSERT INTO public.beer(brewery_id, name, style, price, abv, image, description) VALUES
    ...
    (4, 'Love City Lager', 'American Golden Lager', 5, 4, '', 'Love City Lager is brewed for everybody. Our American Golden Lager is simple, clean, and true to its roots. Lightly malty and a hint of orange aromatics give every bright sip a clean landing.'),
    (4, 'Lime City Lager', 'Lime-infused Lager', 6, 4, '', 'That feeling you get when surrounded by good friends & sunshine! Made with lime and sea salt for a bright, refreshing taste. The perfect beer for warm weather & good times.'),
    (4, 'Sure Shot', 'Kölsch', 7, 4.4, '', 'The ultimate session beer! Refreshing and light-bodied, our Kölsch is balanced with pilsner malt and features subtle fruit and spice character.'),
    (4, 'Deep Cut', 'Pilsner', 7, 5, '', 'Pilsner is the beer that brewers reach for. Like a musician’s favorite track, it’s a Deep Cut. This one is made with all German malt and hops. Lightly bready malt character with floral and herbal hop notes. It’s crisp, complex & crushable.'),
    (4, 'Sylvie', 'Oatmeal Stout', 7, 5, '', 'This English-style oatmeal stout is silky smooth and lightly sweet. This year-round stout is brewed with dark, roasted malts that lend rich dark chocolate and espresso flavors. The addition of oats lends a smooth, round finish.'),
    (4, 'Solid State', 'Helles Lager', 7, 5, '', 'Solid State is a Munich-style Helles brewed with German malt and hops. Lightly bready with subtle floral, herbal hop character and a crisp finish. The beer to reach for after a long day'),
    (4, 'Unity', 'American IPA', 7, 5.5, '', 'This approachable IPA brings hop lovers together around the citrus flavors of our hop blend. It is assertive, yet highly drinkable. Low bitterness and a crisp finish.'),
    ...
    (8, 'Choking Hazard', 'Hoppy', 4, 5.3, '', 'Originally brewed in collaboration with Philly grindcore powerhouse, DIE CHOKING. We used exclusively Nelson Sauvin hops and kept the ABV low at 5.3% to bring you a beer that becomes a “Choking Hazard” when you start crushing these too fast! Notes of grape, gooseberry and dank.'),
    (8, 'Severed Paths', 'Dark Lager', 5, 8.6, '', 'Cold fermented using lager yeast, this excellent historic style has characteristics of a dark lager and a porter, but bumped up a few notches. It''s roasty, malty, with a rounded body that covers up any hint of its strong ABV. Notes of dark fruit, molasses, dark chocolate, and toffee.'),
